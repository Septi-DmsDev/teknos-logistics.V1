...
export const envSchema = z.object({
  ...
  JNE_COD_ELIGIBLE_SERVICES: z.string().default('REG,OKE'),
  JNE_COD_FEE_PERCENT: z.coerce.number().min(0).max(100).default(2.5),
  JNE_COD_MIN_FEE_IDR: z.coerce.number().int().nonnegative().default(5000),
