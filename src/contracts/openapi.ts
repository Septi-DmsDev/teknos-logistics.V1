    ...
    schemas: {
      ...
      RateRequest: {
        ...
        properties: {
          ...
          is_cod: { type: 'boolean' },
          goods_value_idr: { type: 'integer', minimum: 0, maximum: 1000000000 },
      ...
      Rate: {
        ...
        properties: {
          ...
          etd: { type: 'string' },
          cached: { type: 'boolean' },
          availableForCod: { type: 'boolean' },
          codFee: { type: 'integer', minimum: 0 },
          availableForInsurance: { type: 'boolean' },
          insuranceFee: { type: 'integer', minimum: 0 },
        },
        additionalProperties: false,
      },
      RateResponse: {
