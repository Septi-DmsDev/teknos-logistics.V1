...
- **Updated:** 2026-06-19 - Sprint 8 hardening completed: health/readiness, rate limiting, persistent admin audit logs, audit visibility, cleanup utility, and runbook/readiness gate. Migration `20260619093000_add_admin_audit_logs` applied via `localhost:5433 -> 10.0.8.12:5432`.
