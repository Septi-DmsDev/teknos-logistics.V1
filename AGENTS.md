...
- **Updated:** 2026-06-19 - Sprint 7 admin config Tasks 1-6 implemented; migration applied and smoke passed via tunnel `localhost:5433 -> 10.0.8.12:5432`.
...
- `npm run smoke:admin-config` passed; it creates synthetic admin config rows only and does not call JNE or create AWB/resi.
