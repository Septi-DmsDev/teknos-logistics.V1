...
const checks = [
  checkFileIncludes('src/config/env.ts', ['SAP_API_BASE_URL', 'SAP_TRACKING_BASE_URL', 'SAP_API_KEY', 'SAP_CUSTOMER_CODE_NON_COD', 'SAP_CUSTOMER_CODE_COD', 'SAP_WEBHOOK_TOKEN']),
  checkFileIncludes('.env.example', ['SAP_API_BASE_URL=', 'SAP_API_KEY=', 'SAP_CUSTOMER_CODE_NON_COD=', 'SAP_CUSTOMER_CODE_COD=', 'SAP_WEBHOOK_TOKEN=']),
  ...
  checkFileIncludes('src/couriers/sap-express/sap-express.adapter.ts', ['getRates', 'bookShipment', 'trackShipment', 'normalizeWebhook', 'getCustomerCode', 'SAP_NOT_CONFIGURED']),
  ...
  checkFileIncludes('tests/sap-express/sap-express.adapter.test.ts', ['getRates returns normalized CourierRate array', 'uses SAP COD customer code', 'bookShipment returns booking result', 'trackShipment returns normalized tracking events']),
]
