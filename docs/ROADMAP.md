...
| Sprint 7 | Logistics admin config MVP | Merchant, store/branch/origin, courier service config, API key/webhook endpoint management, shipment/relay visibility. Spec: `docs/superpowers/specs/2026-06-18-logistics-admin-config-mvp-design.md`; Plan: `docs/superpowers/plans/2026-06-18-logistics-admin-config-mvp.md` | Planned |
