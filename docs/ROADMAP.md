...
| Sprint 7 | Logistics admin config MVP | In progress - Tasks 1-6 implemented and pushed; DB migration/smoke pending valid Postgres auth. Spec: `docs/superpowers/specs/2026-06-18-logistics-admin-config-mvp-design.md`; Plan: `docs/superpowers/plans/2026-06-18-logistics-admin-config-mvp.md` | In Progress |
